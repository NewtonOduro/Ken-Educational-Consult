  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium cursor-pointer transition-all focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        navy: "surface-navy font-semibold shadow-[var(--shadow-lift)] hover:-translate-y-0.5",
        glass:
          "border border-navy-foreground/35 bg-navy-foreground/10 text-navy-foreground font-semibold backdrop-blur-md hover:bg-navy-foreground/20 hover:-translate-y-0.5",
        goldOutline:
          "border border-gold/70 text-gold-foreground font-semibold hover:bg-gold hover:text-gold-foreground",
      },
      size: {
